...
SCENARIOS = [
    ...
    _scenario("commitment", "pass", "driver", ["We are moving forward.", "I have decided to make the move.", "This is the direction I am taking.", "We are ready to proceed with the transition.", "I am committing to the switch."], "The advisor makes an explicit positive commitment."),
